# Register additional view paths, giving them priority over the default ones.
...
```php
$laravelViewPaths = new IurieMalai\LaravelViewPaths();
echo $laravelViewPaths->echoPhrase('Hello, IurieMalai!');
```
